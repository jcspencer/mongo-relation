...
// support for mongoose > 3.9.x
//           mongoose > 3.9.x       mongoose < 3.9.x
//utils.merge(MongooseArray.mixin || MongooseArray.prototype, mixin);
...
(MongooseArray.mixin || MongooseArray.prototype).build = function (objs) {
...
(MongooseArray.mixin || MongooseArray.prototype).create = function (objs, callback) {
...
(MongooseArray.mixin || MongooseArray.prototype).append = function (child, callback) {
...
* @api public
*/
(MongooseArray.mixin || MongooseArray.prototype)._concat = Array.prototype.concat;
(MongooseArray.mixin || MongooseArray.prototype).concat = function (docs, callback) {
...
*/
(MongooseArray.mixin || MongooseArray.prototype).find = function (conditions, fields, options, callback) {
...
* @api public
*/
(MongooseArray.mixin || MongooseArray.prototype).populate = function (fields, callback) {
...
* @api public
*/
(MongooseArray.mixin || MongooseArray.prototype)._remove = (MongooseArray.mixin || MongooseArray.prototype).remove;
(MongooseArray.mixin || MongooseArray.prototype).remove = (MongooseArray.mixin || MongooseArray.prototype).delete = function (id, callback) {
